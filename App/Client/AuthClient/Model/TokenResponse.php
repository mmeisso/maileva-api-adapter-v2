...
class TokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets accessToken
     *
     * @param string|null $accessToken Token d'accès pour accéder aux ressources de l'utilisateur
     *
     * @return self
     */
     ...
     * Sets expiresIn
     *
     * @param int|null $expiresIn Délai d'expiration du token (en secondes)
     *
     * @return self
     */
