...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://connexion.maileva.com/auth/realms/services/protocol/openid-connect';
    ...
    {
        $report  = 'PHP SDK (MailevaApiAdapter\App\Client\AuthClient) Debug Report:' . PHP_EOL;
