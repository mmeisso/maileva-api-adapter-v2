...
/**
     ...
     * @param  \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentCreationMetadata $metadata metadata (optional)
     ...
     * @return \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto
     */
     ...
     * @param  \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentCreationMetadata $metadata (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDocument'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\MailevaCoproClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function createDocumentWithHttpInfo($sendingId, $document, $metadata = null, string $contentType = self::contentTypes['createDocument'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse', []),
            ...
            $returnType = '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse',
     ...
     * @throws \MailevaApiAdapter\App\Client\MailevaCoproClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponse|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorResponse
     */
    ...
    public function getDocumentWithHttpInfo($sendingId, $documentId, string $contentType = self::contentTypes['getDocument'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 401:
                    if ('\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            switch ($e->getCode()) {
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \MailevaApiAdapter\App\Client\MailevaCoproClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto
     */
     ...
     * @throws \MailevaApiAdapter\App\Client\MailevaCoproClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse|\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentsWithHttpInfo($sendingId, $startIndex = 1, $count = 30, $sort = null, $desc = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sendingId Identifiant de l&#39;envoi (required)
     * @param  string $documentId Identifiant du document (required)
     * @param  \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentUpdateMetadata $metadata metadata (optional)
     ...
     * @param  string $sendingId Identifiant de l&#39;envoi (required)
     * @param  string $documentId Identifiant du document (required)
     * @param  \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentUpdateMetadata $metadata (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDocument'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\MailevaCoproClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
