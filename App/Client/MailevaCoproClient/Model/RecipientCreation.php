...
class RecipientCreation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecipientCreation';
    ...
    protected static $openAPITypes = [
        ...
        'customId' => 'string',
        'customData' => 'string',
        'registeredMailDetail' => '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\RegisteredMailDetail',
        'electronicNoticeDetail' => '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ElectronicNoticeDetail',
    ...
    protected static $openAPIFormats = [
        ...
        'customId' => null,
        'customData' => null,
        'registeredMailDetail' => null,
        'electronicNoticeDetail' => null,
    ...
    protected static array $openAPINullables = [
		...
		'customId' => false,
		'customData' => false,
		'registeredMailDetail' => false,
		'electronicNoticeDetail' => false,
    ...
    protected static $attributeMap = [
        ...
        'registeredMailDetail' => 'registered_mail_detail',
        'electronicNoticeDetail' => 'electronic_notice_detail',
    ...
    protected static $setters = [
        ...
        'registeredMailDetail' => 'setRegisteredMailDetail',
        'electronicNoticeDetail' => 'setElectronicNoticeDetail',
    ...
    protected static $getters = [
        ...
        'registeredMailDetail' => 'getRegisteredMailDetail',
        'electronicNoticeDetail' => 'getElectronicNoticeDetail',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('registeredMailDetail', $data ?? [], null);
        $this->setIfExists('electronicNoticeDetail', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sendingMode'] === null) {
            $invalidProperties[] = "'sendingMode' can't be null";
        }
     ...
     * Sets sendingMode
     *
     * @param string $sendingMode Mode d'envoi du destinataire. Il peut être papier, électronique ou passer par le service de consentement. Si le consentement est donné par le destinataire, le mode d'envoi sera électronique, sinon il sera papier.
     *
     * @return self
     */
    ...
    public function setCustomData($customData)
    {
        ...
        if ((mb_strlen($customData) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customData when calling RecipientCreation., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets registeredMailDetail
     *
     * @return \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\RegisteredMailDetail|null
     */
    public function getRegisteredMailDetail()
    {
        return $this->container['registeredMailDetail'];
    }

    /**
     * Sets registeredMailDetail
     *
     * @param \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\RegisteredMailDetail|null $registeredMailDetail registeredMailDetail
     *
     * @return self
     */
    public function setRegisteredMailDetail($registeredMailDetail)
    {
        if (is_null($registeredMailDetail)) {
            throw new \InvalidArgumentException('non-nullable registeredMailDetail cannot be null');
        }
        $this->container['registeredMailDetail'] = $registeredMailDetail;

        return $this;
    }

    /**
     * Gets electronicNoticeDetail
     *
     * @return \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ElectronicNoticeDetail|null
     */
    public function getElectronicNoticeDetail()
    {
        return $this->container['electronicNoticeDetail'];
    }

    /**
     * Sets electronicNoticeDetail
     *
     * @param \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\ElectronicNoticeDetail|null $electronicNoticeDetail electronicNoticeDetail
     *
     * @return self
     */
    public function setElectronicNoticeDetail($electronicNoticeDetail)
    {
        if (is_null($electronicNoticeDetail)) {
            throw new \InvalidArgumentException('non-nullable electronicNoticeDetail cannot be null');
        }
        $this->container['electronicNoticeDetail'] = $electronicNoticeDetail;
