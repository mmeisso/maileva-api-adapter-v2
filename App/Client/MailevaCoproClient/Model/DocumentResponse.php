...
class DocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'detail' => 'string',
        'metadata' => '\MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponseMetadata'
    ];
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Statut de la vérification du document
     *
     * @return self
     */
     ...
     * Sets detail
     *
     * @param string|null $detail Raison du rejet (statut REJECTED uniquement)
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponseMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \MailevaApiAdapter\App\Client\MailevaCoproClient\Model\DocumentResponseMetadata|null $metadata metadata
     *
     * @return self
     */
