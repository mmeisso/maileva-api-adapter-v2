...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('endPage', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['startPage']) && ($this->container['startPage'] < 1)) {
            $invalidProperties[] = "invalid value for 'startPage', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['endPage']) && ($this->container['endPage'] < 1)) {
            $invalidProperties[] = "invalid value for 'endPage', must be bigger than or equal to 1.";
        }
     ...
     * Sets documentId
     *
     * @param string $documentId uid du document préalablement ajouté
     *
     * @return self
     */
     ...
     * Sets startPage
     *
     * @param int|null $startPage Première page. Page 1 du document par défaut.
     *
     * @return self
     */
    public function setStartPage($startPage)
    {
        ...
        if (($startPage < 1)) {
            throw new \InvalidArgumentException('invalid value for $startPage when calling Document., must be bigger than or equal to 1.');
        }
     ...
     * Sets endPage
     *
     * @param int|null $endPage Dernière page. Dernière page du document par défaut.
     *
     * @return self
     */
    ...
    {
        if (is_null($endPage)) {
            throw new \InvalidArgumentException('non-nullable endPage cannot be null');
        }

        if (($endPage < 1)) {
            throw new \InvalidArgumentException('invalid value for $endPage when calling Document., must be bigger than or equal to 1.');
        }
