...
/**
 * DocumentResponseMetadata Class Doc Comment
 *
 * @category Class
 * @package  MailevaApiAdapter\App\Client\MailevaCoproClient
 * @author   OpenAPI Generator team
 ...
 */
class DocumentResponseMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentResponse_metadata';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('adjust', $data ?? [], null);
    ...
    */
     ...
     * Sets priority
     *
     * @param int|null $priority Ordre de priorité du document dans l'envoi.
     *
     * @return self
     */
    ...
    {
        return $this->container['adjust'];
    }

    /**
     * Sets adjust
     *
     * @param bool|null $adjust Ajuste la taille du document et permet de réduire les pages hors format.
     *
     * @return self
     */
    ...
    {
        if (is_null($adjust)) {
            throw new \InvalidArgumentException('non-nullable adjust cannot be null');
        }
        $this->container['adjust'] = $adjust;
     ...
     * Sets type
     *
     * @param string|null $type Type du document
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Poids du document en octets
     *
     * @return self
     */
