...
class DeliveryStatusesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'deliveryStatuses' => '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DeliveryStatusesResponseDeliveryStatusesInner[]',
        'paging' => '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\PagingResponse'
    ];
    ...
    */
     ...
     *
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DeliveryStatusesResponseDeliveryStatusesInner[]|null
     */
     ...
     *
     * @param \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DeliveryStatusesResponseDeliveryStatusesInner[]|null $deliveryStatuses Dans le cadre d'un envoi de courrier simple, seule l'option gestion des PND (plis non distribuables) peut faire l'objet d'un statut de distribution. - N : Numérisé <table border=\"1\">   <tr bgcolor=\"lightgrey\">     <th>Code</th>     <th>Source</th>     <th>Description</th>   </tr>   <tr>     <td>N10</td>     <td>Maileva</td>     <td>PND (Pli Non Distribuable) pour un courrier</td>   </tr> </table>
     *
     * @return self
     */
     ...
     * Gets paging
     *
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\PagingResponse|null
     */
     ...
     * Sets paging
     *
     * @param \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\PagingResponse|null $paging paging
     *
     * @return self
     */
