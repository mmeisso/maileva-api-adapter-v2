...
class RecipientResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'addressLine5' => 'string',
        'addressLine6' => 'string',
        'countryCode' => '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\CountryCode',
        'documentsOverride' => '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsOverrideItem[]',
        'postageClass' => '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientPostageClass',
        'status' => '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientStatus',
        'statusDetail' => 'string',
        'lastDeliveryStatus' => 'string',
        'lastDeliveryStatusDate' => 'string',
        'postagePrice' => 'float',
        'undeliveredMailDate' => '\DateTime',
    ...
    protected static $attributeMap = [
        ...
        'undeliveredMailDate' => 'undelivered_mail_date',
    ...
    protected static $setters = [
        ...
        'undeliveredMailDate' => 'setUndeliveredMailDate',
    ...
    protected static $getters = [
        ...
        'undeliveredMailDate' => 'getUndeliveredMailDate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('postageClass', $data ?? [], null);
        ...
        $this->setIfExists('undeliveredMailDate', $data ?? [], null);
    ...
    */
     ...
     * Gets countryCode
     *
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\CountryCode
     */
     ...
     * Sets countryCode
     *
     * @param \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\CountryCode $countryCode countryCode
     *
     * @return self
     */
     ...
     *
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsOverrideItem[]|null
     */
     ...
     * Gets postageClass
     *
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientPostageClass|null
     */
    public function getPostageClass()
    {
        return $this->container['postageClass'];
    }

    /**
     * Sets postageClass
     *
     * @param \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientPostageClass|null $postageClass postageClass
     *
     * @return self
     */
    public function setPostageClass($postageClass)
    {
        if (is_null($postageClass)) {
            throw new \InvalidArgumentException('non-nullable postageClass cannot be null');
        }
        $this->container['postageClass'] = $postageClass;
     ...
     * Gets status
     *
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientStatus
     */
     ...
     * Sets status
     *
     * @param \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientStatus $status status
     *
     * @return self
     */
    ...
    /**
     * Gets undeliveredMailDate
     *
     * @return \DateTime|null
     */
    public function getUndeliveredMailDate()
    {
        return $this->container['undeliveredMailDate'];
    }

    /**
     * Sets undeliveredMailDate
     *
     * @param \DateTime|null $undeliveredMailDate Date du PND
     *
     * @return self
     */
    public function setUndeliveredMailDate($undeliveredMailDate)
    {
        if (is_null($undeliveredMailDate)) {
            throw new \InvalidArgumentException('non-nullable undeliveredMailDate cannot be null');
        }
        $this->container['undeliveredMailDate'] = $undeliveredMailDate;
