...
/**
 * RecipientCreationImport Class Doc Comment
 *
 * @category Class
 * @package  MailevaApiAdapter\App\Client\SimpleSendingClient
 * @author   OpenAPI Generator team
 ...
 */
class RecipientCreationImport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recipient_creation_import';
    ...
    */
     ...
     * Sets correlationId
     *
     * @param string|null $correlationId Identifiant du destinataire pour la référence
     *
     * @return self
     */
    public function setCorrelationId($correlationId)
    {
        ...
        if ((mb_strlen($correlationId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $correlationId when calling RecipientCreationImport., must be smaller than or equal to 32.');
        }
    ...
    public function setCustomId($customId)
    {
        ...
        if ((mb_strlen($customId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $customId when calling RecipientCreationImport., must be smaller than or equal to 32.');
        }
    ...
    public function setCustomData($customData)
    {
        ...
        if ((mb_strlen($customData) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customData when calling RecipientCreationImport., must be smaller than or equal to 255.');
        }
