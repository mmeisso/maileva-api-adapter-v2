...
namespace MailevaApiAdapter\App\Client\SimpleSendingClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sandbox.maileva.net/mail/v2';
    ...
    {
        $report  = 'PHP SDK (MailevaApiAdapter\App\Client\SimpleSendingClient) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.maileva.com/mail/v2",
                "description" => "Production",
            ],
            [
                "url" => "https://api.sandbox.maileva.net/mail/v2",
                "description" => "Sandbox",
            ]
        ];
    }
