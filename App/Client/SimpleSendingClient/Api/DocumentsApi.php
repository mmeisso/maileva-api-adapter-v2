...
/**
     ...
     * @throws \MailevaApiAdapter\App\Client\SimpleSendingClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse
     */
     ...
     * @throws \MailevaApiAdapter\App\Client\SimpleSendingClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendingsSendingIdDocumentsDocumentIdGetWithHttpInfo($sendingId, $documentId, string $contentType = self::contentTypes['sendingsSendingIdDocumentsDocumentIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse', []),
            ...
            $returnType = '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  string $documentId Identifiant du document (required)
     * @param  \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\Priority $priority priority (optional)
     ...
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  string $documentId Identifiant du document (required)
     * @param  \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\Priority $priority (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendingsSendingIdDocumentsDocumentIdSetPriorityPost'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\SimpleSendingClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \MailevaApiAdapter\App\Client\SimpleSendingClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse
     */
     ...
     * @throws \MailevaApiAdapter\App\Client\SimpleSendingClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendingsSendingIdDocumentsGetWithHttpInfo($sendingId, $startIndex = 1, $count = 30, string $contentType = self::contentTypes['sendingsSendingIdDocumentsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\DocumentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\SendingsSendingIdDocumentsGetRequestMetadata $metadata metadata (optional)
     ...
     * @param  \MailevaApiAdapter\App\Client\SimpleSendingClient\Model\SendingsSendingIdDocumentsGetRequestMetadata $metadata (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendingsSendingIdDocumentsPost'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\SimpleSendingClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
