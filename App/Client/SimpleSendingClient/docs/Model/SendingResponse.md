...
**status** | [**\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\SendingStatus**](SendingStatus.md) |  | [optional]
...
**recipientsCounts** | [**\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\RecipientsCounts**](RecipientsCounts.md) |  | [optional]
...
**envelopeType** | [**\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\EnvelopeType**](EnvelopeType.md) |  | [optional]
...
**printSenderAddress** | **bool** | Impression de l&#39;adresse expéditeur (false par défaut) | [optional]
...
**returnEnvelope** | [**\MailevaApiAdapter\App\Client\SimpleSendingClient\Model\ReturnEnvelopeOutput**](ReturnEnvelopeOutput.md) |  | [optional]
**treatUndeliveredMail** | **bool** | Gestion électronique des PND | [optional]
