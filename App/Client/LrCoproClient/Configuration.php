...
namespace MailevaApiAdapter\App\Client\LrCoproClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.maileva.com/real_estate/v1';
    ...
    {
        $report  = 'PHP SDK (MailevaApiAdapter\App\Client\LrCoproClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.37' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.maileva.com/real_estate/v1",
                "description" => "Production",
            ],
            [
                "url" => "https://api.sandbox.maileva.net/real_estate/v1",
                "description" => "Sandbox",
            ]
        ];
    }
