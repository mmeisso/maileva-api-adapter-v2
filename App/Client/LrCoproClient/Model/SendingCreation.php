    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SendingCreation., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 1)) {
    ...
    public function setCustomId($customId)
    {
        ...
        if ((mb_strlen($customId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customId when calling SendingCreation., must be bigger than or equal to 0.');
        }
    ...
    public function setCustomData($customData)
    {
        ...
        if ((mb_strlen($customData) < 0)) {
            throw new \InvalidArgumentException('invalid length for $customData when calling SendingCreation., must be bigger than or equal to 0.');
        }
