 ...
 */
class ByModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ByModel';
    ...
    */
     ...
     * Sets userLogin
     *
     * @param string|null $userLogin userLogin
     *
     * @return self
     */
    public function setUserLogin($userLogin)
    {
        if (is_null($userLogin)) {
            throw new \InvalidArgumentException('non-nullable userLogin cannot be null');
        }
