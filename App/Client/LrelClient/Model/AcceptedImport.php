...
/**
 * AcceptedImport Class Doc Comment
 *
 * @category Class
 * @package  MailevaApiAdapter\App\Client\LrelClient
 * @author   OpenAPI Generator team
 ...
 */
class AcceptedImport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'accepted_import';
    ...
    */
    ...
    public function setCorrelationId($correlationId)
    {
        ...
        if ((mb_strlen($correlationId) > 32)) {
            throw new \InvalidArgumentException('invalid length for $correlationId when calling AcceptedImport., must be smaller than or equal to 32.');
        }
     ...
     * Sets id
     *
     * @param string|null $id Identifiant du destinataire généré par api
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $id when calling AcceptedImport., must be smaller than or equal to 32.');
        }
