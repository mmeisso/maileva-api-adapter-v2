...
/**
 * DeliveryStatusesResponseDeliveryStatusesInner Class Doc Comment
 *
 * @category Class
 * @package  MailevaApiAdapter\App\Client\LrelClient
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryStatusesResponseDeliveryStatusesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'delivery_statuses_response_delivery_statuses_inner';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Identifiant du statut de distribution
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Statut de distribution
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string|null $date Date du statut de distribution
     *
     * @return self
     */
