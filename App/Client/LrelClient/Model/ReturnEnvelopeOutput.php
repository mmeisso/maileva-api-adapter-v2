...
/**
 * ReturnEnvelopeOutput Class Doc Comment
 *
 * @category Class
 * @package  MailevaApiAdapter\App\Client\LrelClient
 * @author   OpenAPI Generator team
 ...
 */
class ReturnEnvelopeOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'return_envelope_output';
    ...
    public const TYPE_FRANKING_ENVELOPE = 'FRANKING_ENVELOPE';
    public const TYPE_PREPAID_ENVELOPE = 'PREPAID_ENVELOPE';
    ...
    {
        return [
            self::TYPE_FRANKING_ENVELOPE,
            self::TYPE_PREPAID_ENVELOPE,
        ];
    }
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference Référence de l'enveloppe retour
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type d'enveloppe retour. FRANKING_ENVELOPE : Enveloppe à affranchir, PREPAID_ENVELOPE : Enveloppe T
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Identifiant de l'enveloppe retour
     *
     * @return self
     */
