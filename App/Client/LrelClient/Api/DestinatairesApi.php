...
/**
     ...
     * @param  \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientCreation $recipientCreation recipientCreation (required)
     ...
     * @return \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse
     */
     ...
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  string $recipientId Identifiant du destinataire (required)
     * @param  \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientCreation $recipientCreation (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchRecipient'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchRecipientWithHttpInfo($sendingId, $recipientId, $recipientCreation, string $contentType = self::contentTypes['patchRecipient'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse', []),
            ...
            $returnType = '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientResponse',
     ...
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse
     */
     ...
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendingsSendingIdRecipientsGetWithHttpInfo($sendingId, $startIndex = 1, $count = 50, string $contentType = self::contentTypes['sendingsSendingIdRecipientsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  \MailevaApiAdapter\App\Client\LrelClient\Model\ImportRecipients $importRecipients importRecipients (optional)
     ...
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse
     */
     ...
     *
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  \MailevaApiAdapter\App\Client\LrelClient\Model\ImportRecipients $importRecipients (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendingsSendingIdRecipientsImportsPost'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendingsSendingIdRecipientsImportsPostWithHttpInfo($sendingId, $importRecipients = null, string $contentType = self::contentTypes['sendingsSendingIdRecipientsImportsPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\LrelClient\Model\RecipientsImportResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientCreation $recipientCreation recipientCreation (optional)
     ...
     *
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  \MailevaApiAdapter\App\Client\LrelClient\Model\RecipientCreation $recipientCreation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendingsSendingIdRecipientsPost'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse
     */
     ...
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorsResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse|\MailevaApiAdapter\App\Client\LrelClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendingsSendingIdRecipientsRecipientIdDeliveryStatusesGetWithHttpInfo($sendingId, $recipientId, $startIndex = 1, $count = 50, string $contentType = self::contentTypes['sendingsSendingIdRecipientsRecipientIdDeliveryStatusesGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailevaApiAdapter\App\Client\LrelClient\Model\DeliveryStatusesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sendingId Identifiant d&#39;un envoi (required)
     * @param  string $recipientId Identifiant du destinataire (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'] to see the possible values for this operation
     *
     * @throws \MailevaApiAdapter\App\Client\LrelClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet($sendingId, $recipientId, string $contentType = self::contentTypes['sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'][0])
    {
        list($response) = $this->sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetWithHttpInfo($sendingId, $recipientId, $contentType);
        return $response;
    }
     ...
     */
    public function sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetWithHttpInfo($sendingId, $recipientId, string $contentType = self::contentTypes['sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'][0])
    {
        $request = $this->sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetRequest($sendingId, $recipientId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetAsync($sendingId, $recipientId, string $contentType = self::contentTypes['sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'][0])
    {
        return $this->sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetAsyncWithHttpInfo($sendingId, $recipientId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetAsyncWithHttpInfo($sendingId, $recipientId, string $contentType = self::contentTypes['sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetRequest($sendingId, $recipientId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGetRequest($sendingId, $recipientId, string $contentType = self::contentTypes['sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'][0])
    {

        // verify the required parameter 'sendingId' is set
        if ($sendingId === null || (is_array($sendingId) && count($sendingId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sendingId when calling sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'
            );
        }
        if (strlen($sendingId) > 40) {
            throw new \InvalidArgumentException('invalid length for "$sendingId" when calling DestinatairesApi.sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet, must be smaller than or equal to 40.');
        }
        
        // verify the required parameter 'recipientId' is set
        if ($recipientId === null || (is_array($recipientId) && count($recipientId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $recipientId when calling sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet'
            );
        }
        if (strlen($recipientId) > 40) {
            throw new \InvalidArgumentException('invalid length for "$recipientId" when calling DestinatairesApi.sendingsSendingIdRecipientsRecipientIdDownloadAcknowledgementOfReceiptGet, must be smaller than or equal to 40.');
        }
